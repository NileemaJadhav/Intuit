...
class CRM_Event_Payment_IntuitQuickbooks extends Intuit_Payment_IntuitQuickbooks {
    /** 
    ...
    if (self::$_singleton === null ) {
            self::$_singleton = new CRM_Event_Payment_IntuitQuickbooks( $mode, $paymentProcessor );
        }
